...
function renderQuestion(){
 ...
 $("question").innerHTML='<div class="question-text">'+q.text+'</div>'+q.examples.map(x=>'<div class="example">'+x+'</div>').join("");
